...
static struct ctl_table kern_table[] = {
	...
	{
		.procname	= "log_fatal_signals",
		.data		= &sysctl_log_fatal_signals,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
...
static struct ctl_table vm_table[] = {
	...
	{
		.procname	= "oom_verbose",
		.data		= &sysctl_oom_verbose,
		.maxlen		= sizeof(sysctl_oom_verbose),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
	...
	{
		.procname	= "miss_based_ra",
		.data		= &vm_miss_based_ra,
		.maxlen		= sizeof(vm_miss_based_ra),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
		.extra2		= &one,
	...
	{
		.procname	= "file_inactive_ratio",
		.data		= &sysctl_file_inactive_ratio,
		.maxlen		= sizeof(sysctl_file_inactive_ratio),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &one,
		.extra2		= &one_hundred,
